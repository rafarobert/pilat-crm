...
require_once('modules/'.$currentModule.'/license/WhatsAppOutfittersLicense.php');

if($_REQUEST['method'] == 'validate') {
    WhatsAppOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    WhatsAppOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    WhatsAppOutfittersLicense::add();
    ...
    $validate_license = WhatsAppOutfittersLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = WhatsAppOutfittersLicense::doValidate($currentModule);
