...
$outfitters_config = array(
    'name' => 'DT_Duplicate_Preventive', //The matches the id value in your manifest file. This allow the library to lookup addon version from upgrade_history, so you can see what version of addon your customers are using
    'shortname' => 'duplicate-checking', //The short name of the Add-on. e.g. For the url https://www.sugaroutfitters.com/addons/sugaroutfitters the shortname would be sugaroutfitters
    'public_key' => '6dcb2716a6fa25abc0ecd6093db78f62', //The public key associated with the group
