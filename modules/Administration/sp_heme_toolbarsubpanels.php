...
if(!defined('sugarEntry') || !sugarEntry) die('Not A Valid Entry Point');
  ...
  ?>
          ...
          <tbody>
            ...
            <td>
              <div style="padding-bottom:5px;">
                <h2><?php echo $mod_strings['LBL_SP_THEME_TOOLBSUBP_TITLE'];?></h2>
              </div>
               <form action="index.php" method="POST" name="report_form" id="report_form">
                <input type="hidden" name="module" value="Administration">
                <input type="hidden" name="action" value="sp_heme_toolbarsubpanels">
                ...
                <input type="hidden" name="process" value="true">
                    ...
                    <div class="col-md-4">
                         <?php echo $mod_strings['LBL_SP_THEME_TOOLBSUBP_HELP'];?>  
                    </div>
                    </div> 
   ...
   <script type="text/javascript" charset="utf-8">
    ...
    function savedata()
    {
      ...
      webix.ajax().post("index.php?module=Administration&action=sp_heme_toolbarsubpanels&to_pdf=1&sp_action=save", { sp_modules: modulesw },{
   	...
   	var listw;
        ...
        <?php
          ...
          if(!empty($sugar_config['sp_theme_subpanel_setting']))
             $sp_theme_subpanel_setting = json_decode($sugar_config['sp_theme_subpanel_setting']);
          ...
          foreach($treemodules as $e => $v)
          {
              if(!$isfirstm)
               echo ',';
              if(in_array($e, $sp_theme_subpanel_setting))
  ...
  else
  {
        ...
        {
            $sp_theme_subpanel_setting[]=$m;
        }
        $configurator->loadConfig(); 
        $configurator->config['sp_theme_subpanel_setting'] =json_encode($sp_theme_subpanel_setting);
