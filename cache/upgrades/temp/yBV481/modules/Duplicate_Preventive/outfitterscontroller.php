...
require_once('modules/'.$currentModule.'/license/DT_DuplicateCheckingOutfittersLicense.php');

if($_REQUEST['method'] == 'validate') {
    DT_DuplicateCheckingOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    DT_DuplicateCheckingOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    DT_DuplicateCheckingOutfittersLicense::add();
    ...
    $validate_license = DT_DuplicateCheckingOutfittersLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = DT_DuplicateCheckingOutfittersLicense::doValidate($currentModule);
