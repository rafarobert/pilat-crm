...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
           ...
           //translate('LBL_DTDUPLICATECHECKING','Administration').': '.translate('LBL_DTDUPLICATECHECKING_LICENSE_TITLE','Administration'),
           );
    }
    ...
    public function display()
    {
        ...
        $key = DT_DuplicateCheckingOutfittersLicense::getKey($currentModule);
