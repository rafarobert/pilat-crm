<?php 
 $GLOBALS["dictionary"]["Employee"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Cod. Agenda',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'codigo_agenda_c',
      'vname' => 'LBL_CODIGO_AGENDA',
      'type' => 'int',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'Userscodigo_agenda_c',
      'custom_module' => 'Users',
    ),
    'extension_documento_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'extension documento',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'extension_documento_c',
      'vname' => 'LBL_EXTENSION_DOCUMENTO',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'extension_document_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Usersextension_documento_c',
      'custom_module' => 'Users',
    ),
    'numero_documento_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'numero documento',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'numero_documento_c',
      'vname' => 'LBL_NUMERO_DOCUMENTO',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
