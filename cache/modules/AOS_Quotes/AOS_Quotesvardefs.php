 ...
 $GLOBALS["dictionary"]["AOS_Quotes"]=array (
  ...
  array (
    ...
    array (
      ...
      'name' => 'tipo_pago_c',
      'vname' => 'LBL_TIPO_PAGO_C',
      'type' => 'dynamicenum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      'comments' => 'Tipo de Pago',
      'help' => 'Tipo de Pago',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'tipo_pago_c_list',
      'studio' => 'visible',
      'dbType' => 'enum',
      'parentenum' => '',
      'id' => 'AOS_Quotestipo_pago_c',
    ...
    array (
      ...
      'vname' => 'LBL_LBL_TIPOVENTA_C',
      'type' => 'dynamicenum',
      'massupdate' => '1',
      'default' => NULL,
      'no_default' => false,
      'comments' => 'Tipo de Venta',
      'help' => 'Tipo de Venta ',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'lbl_tipoventa_c_list',
      'studio' => 'visible',
      'dbType' => 'enum',
      'parentenum' => '',
      'id' => 'AOS_Quoteslbl_tipoventa_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'term_years_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Plazo en Años',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'term_years_c',
      'vname' => 'LBL_TERM_YEARS_C',
      'type' => 'dynamicenum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      'comments' => 'Plazo en años',
      'help' => 'Plazo en años',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'term_years_c_list',
      'studio' => 'visible',
      'dbType' => 'enum',
      'parentenum' => '',
      'id' => 'AOS_Quotesterm_years_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'moneda_c' => 
    array (
    ...
    array (
      ...
      'vname' => 'LBL_FECHA_ENVIO_PROGRAMADA',
      'type' => 'datetimecombo',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      'comments' => 'Fecha Envió Programada',
      'help' => 'Fecha Envió Programada',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'id' => 'AOS_Quotesfecha_envio_programada_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'fondo_metros_c' => 
    array (
    ...
    array (
      ...
      'enable_range_search' => false,
      'precision' => '2',
      'id' => 'AOS_Quoteslbl_cuotainicial_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'lbl_superficie_c' => 
    array (
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'link_terreno_c',
      'vname' => 'LBL_LINK_TERRENO_C',
      'type' => 'url',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      'comments' => '',
      'help' => 'Url foto o ubicación del terreno',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
    ...
    array (
      ...
      'enable_range_search' => false,
      'precision' => '8',
      'id' => 'AOS_Quotesprecio_mcuadrado_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'saldo_c' => 
    array (
    ...
    array (
      ...
      'vname' => 'LBL_SALDO_CUOTA_INICAL_C',
      'type' => 'decimal',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => '8',
      'id' => 'AOS_Quotessaldo_cuota_inical_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'ubicacion_c' => 
    array (
    ...
    array (
      ...
      'vname' => 'LBL_UNIDAD_INDUSTRIAL_C',
      'type' => 'int',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      'comments' => '',
      'help' => 'Unidad Industrial',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'AOS_Quotesunidad_industrial_c',
      'custom_module' => 'AOS_Quotes',
    ),
  ),
  'relationships' => 
