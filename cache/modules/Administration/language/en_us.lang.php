...
',
  ...
  'LBL_ANALYTICREPORTING' => 'Analytic Reporting',
  'LBL_ANALYTICREPORTING_LICENSE_TITLE' => 'License Configuration',
  'LBL_ANALYTICREPORTING_LICENSE' => 'Manage and configure the license for Analytic Reporting',
  'LBL_DT_DUPLICATE_CHECKING' => 'Duplicate Checking Configuration Panel',
  'LBL_DT_DUPLICATE_CHECKING_LICENSE_TITLE' => 'License Configuration',
  'LBL_DT_DUPLICATE_CHECKING_LICENSE' => 'Manage and configure the license for this add-on',
  'LBL_DT_DUPLICATE_CHECKING_CONFIGURATION' => 'Duplicate Checking Configuration Settings',
  'LBL_DT_DUPLICATE_CHECKING_MESSAGE' => 'Duplicate Checking on Account, Contact And Lead Module',
  'LBL_DTWHATSAPP' => 'Waboxapp WhatsApp License Add-on',
  'LBL_DTWHATSAPP_LICENSE_TITLE' => 'License Configuration',
  'LBL_DTWHATSAPP_LICENSE' => 'Manage and configure the license for this add-on',
  'LBL_DTWHATSAPP_LICENSE_WHATSAPP_CONFIGURATION' => 'Whatsapp API Settings',
  'LBL_DTWHATSAPP_LICENSE_MESSAGE' => 'Configure Waboxapp API credentials details',
  'LBL_PARAMETERS' => 'Parámetros Comerciales',
  'LBL_PARAMETER_CONFIG_TITLE' => 'Configuración',
  'LBL_PARAMETER_CONFIG_INFO' => 'Configuración de parámetros comerciales',
  'LBL_SP_THEME_TITLE' => 'Sugar-Project Theme settings',
  'LBL_SP_THEME_CONFIG_TITLE' => 'Settings',
  'LBL_SP_THEME_CONFIG_INFO' => 'Modify settings',
  'LBL_SP_THEME_COLORS_TITLE' => 'Colors Settings',
  'LBL_SP_THEME_COLORS_INFO' => 'Modify theme colors',
  'LBL_SP_THEME_TOOLBSUBP_TITLE' => 'Subpanel Toolbar Settings',
  'LBL_SP_THEME_TOOLBSUBP_INFO' => 'Enable/Disable subpanel toolbar for modules',
  'LBL_SP_THEME_TOOLBSUBP_HELP' => 'Enable/Disable subpanel toolbar for modules',
  'LBL_SP_THEME_GRIDEDIT_TITLE' => ' Listview Grid Edit Settings',
  'LBL_SP_THEME_GRIDEDIT_INFO' => 'Enable/Disable Listview Grid Edit for modules',
  'LBL_SP_THEME_GRIDEDIT_HELP' => 'Enable/Disable Listview Grid Edit for modules',
  'LBL_SP_THEME_CALENDAR_TITLE' => 'Calendar Settings',
  'LBL_SP_THEME_CALENDAR_INFO' => 'Modify Calendar Settings',
  'LBL_SP_THEME_CALENDAR_FIELD_DURATION' => 'Field duration',
  'LBL_SP_THEME_CALENDAR_EVENT' => 'Field event',
  'LBL_SP_THEME_CALENDAR_DURATION' => 'Durat. (m)',
  'LBL_SP_THEME_CALENDAR_FIELDSTODISPLAY' => 'Fields to display',
  'LBL_SP_THEME_CALENDAR_EVENT_END' => 'Field event end',
  'LBL_SP_THEME_CALENDAR_MODULE' => 'Module',
  'LBL_SP_THEME_CALENDAR_ADD' => 'Add row',
  'LBL_SP_THEME_CALENDAR_REMOVE' => 'Remove row',
  'LBL_SP_THEME_CALENDAR_HELP' => '',
  'LBL_SP_THEME_KANBAN_TITLE' => 'Kanban Settings',
  'LBL_SP_THEME_KANBAN_INFO' => 'Modify Kanban Settings',
  'LBL_SP_THEME_KANBAN_ADD' => 'Add row',
  'LBL_SP_THEME_KANBAN_REMOVE' => 'Remove row',
  'LBL_SP_THEME_KANBAN_MODULE' => 'Module',
  'LBL_SP_THEME_KANBAN_FIELD' => 'Field to group',
  'LBL_SP_THEME_KANBAN_TEMPLATE' => 'Template',
  'LBL_SP_THEME_KANBAN_HELP' => '',
  'LBL_SP_THEME_CALCULATOR_TITLE' => 'Expressions Settings',
  'LBL_SP_THEME_CALCULATOR_INFO' => 'Modify Expressions Settings',
  'LBL_SP_THEME_CALCULATOR_ADD' => 'Add row',
  'LBL_SP_THEME_CALCULATOR_REMOVE' => 'Remove row',
  'LBL_SP_THEME_CALCULATOR_MODULE' => 'Module',
  'LBL_SP_THEME_CALCULATOR_FIELD' => 'Add field to expr.',
  'LBL_SP_THEME_CALCULATOR_EXPRESSION' => 'Expression',
  'LBL_SP_THEME_CALCULATOR_DECIMALS' => 'Decimals',
  'LBL_SP_THEME_CALCULATOR_LABEL' => 'Label',
  'LBL_SP_THEME_CALCULATOR_HELP' => '',
  'LBL_SP_THEME_ADMIN_DESC' => 'Sugar-Project admin settings',
  'LBL_SP_THEME_MAINCOLOR' => 'Theme Main color',
  'LBL_SP_THEME_LINECOLOR' => 'Theme line color',
  'LBL_SP_THEME_BUTTONCOLOR' => 'Theme button color',
  'LBL_SP_THEME_CANCEL' => 'Cancel',
  'LBL_SP_THEME_CONFIRM' => 'Save',
  'LBL_SP_THEME_TOOLBARSUBPANELS' => 'Subpanel toolbar max tabs',
  'LBL_SP_THEME_TOOLBARSUBPANELS_INFO' => 'help ....',
  'LBL_SP_THEME_MAXMENUITEMS' => 'Left menu max items',
  'LBL_SP_THEME_MAXMENUITEMS_INFO' => 'help ....',
  'LBL_SP_THEME_TOP_TOOLBAR_TITLE' => 'Toolbar Settings',
  'LBL_SP_THEME_TOP_TOOLBAR_INFO' => 'Modify Toolbar',
  'LBL_SP_THEME_TOP_TOOLBAR_SELICONS' => 'Icon Library',
  'LBL_SP_THEME_TOP_TOOLBAR_ICON' => 'Icon',
  'LBL_SP_THEME_TOP_TOOLBAR_URL' => 'Url',
  'LBL_SP_THEME_TOP_TOOLBAR_NAME' => 'Name',
  'LBL_SP_THEME_TOP_TOOLBAR_ADD' => 'Add icon',
  'LBL_SP_THEME_TOP_TOOLBAR_REMOVE' => 'Remove icon',
  'LBL_SP_THEME_TOP_TOOLBAR_TARGET' => 'New window',
  'LBL_SP_THEME_SHOWMENULEFT' => 'Show company logo',
  'LBL_SP_THEME_SHOWMENULEFT_INFO' => 'select if you want to show company logo on the left manu',
);