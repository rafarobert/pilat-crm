...
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}"  border="0" id="{$fields.date_end.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}&nbsp;
</td>
<td nowrap>
...
document.getElementById('{$fields.date_end.name}_time_section').innerHTML = '<span style="top:-6px;"'+text+'</span>';
...
<script type="text/javascript">
addForm('form_SubpanelQuickCreate_Meetings');addToValidate('form_SubpanelQuickCreate_Meetings', 'name', 'name', false,'{/literal}{sugar_translate label='LBL_SUBJECT' module='Meetings' for_js=true}{literal}' );
...
addToValidate('form_SubpanelQuickCreate_Meetings', 'tipo_asunto_c', 'enum', true,'{/literal}{sugar_translate label='LBL_TIPO_ASUNTO' module='Meetings' for_js=true}{literal}' );
