...
<div class="form-group col-md-6" >
<label>
{capture name="label" assign="label"}{sugar_translate label='LBL_NUEVO_RUBRO_C' module='Leads'}{/capture}
{$label|strip_semicolon}:
</label>
{counter name="fieldsUsed"}
...
{if strlen($fields.nuevo_rubro_c.value) <= 0}
{assign var="value" value=$fields.nuevo_rubro_c.default_value }
{else}
{assign var="value" value=$fields.nuevo_rubro_c.value }
{/if}  
<input type='text' name='{$fields.nuevo_rubro_c.name}' 
id='{$fields.nuevo_rubro_c.name}' size='30' 
maxlength='255' 
value='{$value}' title='Nuevo Rubro'       >
</div>  
<div class="form-group col-md-6" >
<label>
&nbsp;
...
addToValidate('EditView', 'etapas_c', 'dynamicenum', true,'{/literal}{sugar_translate label='LBL_ETAPAS' module='Leads' for_js=true}{literal}' );
...
addToValidate('EditView', 'nuevo_rubro_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NUEVO_RUBRO_C' module='Leads' for_js=true}{literal}' );
