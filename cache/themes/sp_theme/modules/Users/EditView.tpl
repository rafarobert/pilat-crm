...
<li  class="active"><a id="tab1" data-toggle="tab" href="#tab-1"><em>{$MOD.LBL_USER_INFORMATION}</em></a></li>
<li {if $CHANGE_PWD == 0}style='display:none'{/if}><a id="tab2" data-toggle="tab" href="#tab-2"><em>{$MOD.LBL_CHANGE_PASSWORD_TITLE}</em></a></li>
{if $SHOW_THEMES}
<li><a id="tab3" href="#tab-3" data-toggle="tab" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'><em>{$MOD.LBL_THEME}</em></a></li>
{/if}
<li><a id="tab4" href="#tab-4" data-toggle="tab" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'><em>{$MOD.LBL_ADVANCED}</em></a></li>
{if $ID}
<li><a id="tab5" href="#tab-5" data-toggle="tab"  style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'><em>{$MOD.LBL_EAPM_SUBPANEL_TITLE}</em></a></li>
{/if}
</ul>
...
{if strlen($fields.codigo_agenda_c.value) <= 0}
{assign var="value" value=$fields.codigo_agenda_c.default_value }
{else}
{assign var="value" value=$fields.codigo_agenda_c.value }
{/if}  
<input type='text' name='{$fields.codigo_agenda_c.name}' 
id='{$fields.codigo_agenda_c.name}' style="max-width:170px;" size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>  
<div class="form-group col-md-6" >
<label>
&nbsp;
...
<tr>
<td width='50%'>
<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey='{$APP.LBL_SAVE_BUTTON_KEY}' class='button primary' id='save_new_pwd_button' LANGUAGE=javascript onclick='if (set_password(this.form)) window.close(); else return false;' type='submit' name='button' style='display:none;' value='{$APP.LBL_SAVE_BUTTON_LABEL}'>
</td>
<td width='50%'>
</td>
</tr>
...
addToValidate('EditView', 'numero_documento_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NUMERO_DOCUMENTO' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'extension_documento_c', 'enum', false,'{/literal}{sugar_translate label='LBL_EXTENSION_DOCUMENTO' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'codigo_agenda_c', 'int', false,'{/literal}{sugar_translate label='LBL_CODIGO_AGENDA' module='Users' for_js=true}{literal}' );
