...
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}"  border="0" id="{$fields.date_due.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}&nbsp;
</td>
<td nowrap>
...
document.getElementById('{$fields.date_due.name}_time_section').innerHTML = '<span style="top:-6px;"'+text+'</span>';
