...
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style=" padding-left:6px" border="0" id="{$fields.estimated_start_date.name}_trigger"{/capture}
...
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style=" padding-left:6px" border="0" id="{$fields.estimated_end_date.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</td></tr></table>
</span>
<script type="text/javascript">
