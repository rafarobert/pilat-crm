...
addToValidate('EditView', 'superficie_c', 'decimal', false,'{/literal}{sugar_translate label='LBL_SUPERFICIE' module='Opportunities' for_js=true}{literal}' );
