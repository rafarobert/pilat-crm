...
addToValidate('form_QuickCreate_Accounts', 'numero_documento_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NUMERO_DOCUMENTO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'extension_documento_c', 'enum', false,'{/literal}{sugar_translate label='LBL_EXTENSION_DOCUMENTO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'nit_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NIT' module='Accounts' for_js=true}{literal}' );
