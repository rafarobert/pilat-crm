...
<li class="active"><a id="tab0" href="#tab-0" data-toggle="tab"><em>{sugar_translate label='LBL_CALL_INFORMATION' module='Calls'}</em></a></li>

<li class=""><a id="tab1" href="#tab-1" data-toggle="tab"><em>{sugar_translate label='LBL_RESCHEDULE_PANEL' module='Calls'}</em></a></li>

<li class=""><a id="tab2" href="#tab-2" data-toggle="tab"><em>{sugar_translate label='LBL_PANEL_ASSIGNMENT' module='Calls'}</em></a></li>
</ul>
