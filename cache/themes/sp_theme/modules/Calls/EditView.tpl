...
addToValidate('EditView', 'message_id_c', 'varchar', false,'{/literal}{sugar_translate label='MESSAGE_ID' module='Calls' for_js=true}{literal}' );
addToValidate('EditView', 'llamada_fecha_c_date', 'date', true,'LBL_LLAMADA_FECHA_C' );
addToValidate('EditView', 'llamada_realizada_c', 'bool', false,'{/literal}{sugar_translate label='LBL_LLAMADA_REALIZADA_C' module='Calls' for_js=true}{literal}' );
