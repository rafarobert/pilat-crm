...
<div class="form-group col-md-6" >
<label>
{capture name="label" assign="label"}{sugar_translate label='LBL_NUMERO_DOCUMENTO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</label>
{counter name="fieldsUsed"}
...
<div class="form-group col-md-6" >
<label>
{capture name="label" assign="label"}{sugar_translate label='LBL_EXTENSION_DOCUMENTO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</label>
{counter name="fieldsUsed"}
...
<div class="form-group col-md-6" >
<label>
{capture name="label" assign="label"}{sugar_translate label='LBL_GENERO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</label>
{counter name="fieldsUsed"}
...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.genero_c.name}-input', '{$fields.genero_c.name}');sync_{$fields.genero_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
<div class="form-group col-md-6" >
<label>
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSISTANT_PHONE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</label>
{counter name="fieldsUsed"}
...
{/if}  
<input type='text' name='{$fields.assistant_phone.name}' id='{$fields.assistant_phone.name}' size='30' maxlength='100' value='{$value}' title='' tabindex='0'	  class="phone" >
</div>  
<div class="form-group col-md-6" >
<label>
...
addToValidate('EditView', 'genero_c', 'enum', false,'{/literal}{sugar_translate label='LBL_GENERO' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'numero_documento_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NUMERO_DOCUMENTO' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'extension_documento_c', 'enum', false,'{/literal}{sugar_translate label='LBL_EXTENSION_DOCUMENTO' module='Contacts' for_js=true}{literal}' );
