...
addToValidate('form_QuickCreate_Contacts', 'genero_c', 'enum', false,'{/literal}{sugar_translate label='LBL_GENERO' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'numero_documento_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NUMERO_DOCUMENTO' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'extension_documento_c', 'enum', false,'{/literal}{sugar_translate label='LBL_EXTENSION_DOCUMENTO' module='Contacts' for_js=true}{literal}' );
