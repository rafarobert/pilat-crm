...
id='{$fields.margin_left.name}' style="max-width:170px;" size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>  
<div class="form-group col-md-6" >
<label>
...
id='{$fields.margin_right.name}' style="max-width:170px;" size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>  
{counter name="fieldsUsed" start=0 print=false assign="fieldsUsed"}
<div class="form-group col-md-6" >
<label>
...
id='{$fields.margin_top.name}' style="max-width:170px;" size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>  
<div class="form-group col-md-6" >
<label>
...
id='{$fields.margin_bottom.name}' style="max-width:170px;" size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>  
{counter name="fieldsUsed" start=0 print=false assign="fieldsUsed"}
<div class="form-group col-md-6" >
<label>
...
id='{$fields.margin_header.name}' style="max-width:170px;" size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>  
<div class="form-group col-md-6" >
<label>
...
id='{$fields.margin_footer.name}' style="max-width:170px;" size='30' maxlength='255' value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>  
</div>   
