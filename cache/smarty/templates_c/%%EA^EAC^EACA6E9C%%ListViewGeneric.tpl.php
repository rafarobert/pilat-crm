<?php /* Smarty version 2.6.31, created on 2021-02-23 15:18:13
         compiled from themes%5Csp_theme%5Cinclude/ListView/ListViewGeneric.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 60, false),array('modifier', 'default', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 174, false),array('modifier', 'lower', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 176, false),array('modifier', 'upper', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 179, false),array('function', 'counter', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 162, false),array('function', 'sugar_translate', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 184, false),array('function', 'sugar_getimage', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 190, false),array('function', 'sugar_ajax_url', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 265, false),array('function', 'sugar_evalcolumn_old', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 269, false),array('function', 'sugar_field', 'themes\\sp_theme\\include/ListView/ListViewGeneric.tpl', 271, false),)), $this); ?>
...
<?php $this->assign('cards_cols', 0); ?>
<?php $this->assign('pathtplcards', $this->_tpl_vars['pageData']['bean']['moduleDir']); ?>
<?php $this->assign('cookname', "view_".($this->_tpl_vars['pathtplcards'])); ?>
<?php $this->assign('pathtplcards', "custom/modules/".($this->_tpl_vars['pathtplcards'])."/cardview4.tpl"); ?>
<?php if (file_exists ( $this->_tpl_vars['pathtplcards'] )): ?> 
    <?php $this->assign('cards_cols', 4); ?>
    <?php $this->assign('cards_colssm', 3); ?>
<?php else: ?>
    <?php $this->assign('pathtplcards', $this->_tpl_vars['pageData']['bean']['moduleDir']); ?>
    <?php $this->assign('pathtplcards', "custom/modules/".($this->_tpl_vars['pathtplcards'])."/cardview2.tpl"); ?>
    <?php if (file_exists ( $this->_tpl_vars['pathtplcards'] )): ?> 
       <?php $this->assign('cards_cols', 2); ?>
       <?php $this->assign('cards_colssm', 6); ?>
    <?php endif; ?>   
<?php endif; ?>   

<?php if ($this->_tpl_vars['cards_cols'] > 0 && $_COOKIE[$this->_tpl_vars['cookname']] == 'cards'): ?> 
<div class="hpanel">
  <div class="panel-body" style="background-color:transparent;">
    <table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view table'  style="background-color:#FFF;">     
        <thead>
...
?>  
        ...
        <?php if (!(( $this->_foreach['rowIteration']['iteration']-1 ) % $this->_tpl_vars['cards_cols'])): ?>
            <?php if ($this->_foreach['rowIteration']['iteration'] <> 1): ?>
             </div>
            <?php endif; ?>
             <div class="row">
                
        <?php endif; ?>
         <div class="col-sm-<?php echo $this->_tpl_vars['cards_colssm']; ?>
">
           <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => $this->_tpl_vars['pathtplcards'], 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
         </div>  
...
<?php else: ?>
     <div class="hpanel">
      <div class="panel-body">
       <table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view table footable table-stripped toggle-arrow-tiny' data-page-size="1000">    
        <thead>
        <?php $this->assign('link_select_id', 'selectLinkTop'); ?>
        <?php $this->assign('link_action_id', 'actionLinkTop'); ?>
        <?php $this->assign('actionsLink', $this->_tpl_vars['actionsLinkTop']); ?>
...
?>      
                            <?php if ($this->_tpl_vars['params']['default'] != 1): ?><th  data-hide="all"><?php else: ?>
                              <?php if ($this->_tpl_vars['params']['name'] != 'name'): ?>
