<?php /* Smarty version 2.6.31, created on 2019-08-01 10:15:33
         compiled from modules/Duplicate_Preventive/license/tpls/license.tpl */ ?>
...
<?php echo '\', function() {
    ...
    {
        var curl_not_enabled = \''; ?>
<?php echo $this->_tpl_vars['CURL_NOT_ENABLED']; ?>
<?php echo '\';
        if(curl_not_enabled) {
'; ?>
<?php if ($this->_tpl_vars['IS_SUGAR_6'] == true): ?><?php echo '
...
<?php if ($this->_tpl_vars['IS_SUGAR_6'] == true): ?><?php echo '
        window.location=\''; ?>
<?php echo $this->_tpl_vars['continue_url']; ?>
<?php echo '\';
'; ?>
<?php else: ?><?php echo '
        var app = window.parent.SUGAR.App;
        app.router.navigate(\''; ?>
<?php echo $this->_tpl_vars['continue_url']; ?>
<?php echo '\', {trigger:true, replace:true});
'; ?>
<?php endif; ?><?php echo '
    }
</script>
