<?php /* Smarty version 2.6.31, created on 2021-02-23 15:16:03
         compiled from themes%5Csp_theme%5Cinclude/MySugar/tpls/MySugar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getscript', 'themes\\sp_theme\\include/MySugar/tpls/MySugar.tpl', 73, false),array('function', 'counter', 'themes\\sp_theme\\include/MySugar/tpls/MySugar.tpl', 93, false),array('function', 'sugar_getjspath', 'themes\\sp_theme\\include/MySugar/tpls/MySugar.tpl', 261, false),)), $this); ?>
<?php echo '
    <style>
        .menu {
            z-index: 100;
       ...
       .modal-edit-dashboard .btn-danger {
            height: 30px;
            width: 33px;
            padding: 0px;
            margin-left:20px;
        }    
        .modal-edit-dashboard  .panel-template {
            visibility: collapse;
        }        
    </style>
'; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'themes/sp_theme/include/MySugar/tpls/actions_menu.tpl', 'smarty_include_vars' => array()));
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="button btn-success btn-add-dashboard" data-dismiss="modal"><?php echo $this->_tpl_vars['lblAddTab']; ?>
</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
...
"<?php echo ',
    ...
    $(function() {
      $(\'.modal-add-dashlet\').find(\'button\').on("click", function(){
     //    $(\'#dashletsDialog_mask\').css(\'display\', \'none\');
         $(\'#dashletsDialog_mask\').remove();
