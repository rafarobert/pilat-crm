<?php /* Smarty version 2.6.31, created on 2020-11-13 21:10:43
         compiled from modules/AnalyticReporting/templates/main.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'json_encode', 'modules/AnalyticReporting/templates/main.tpl', 50, false),)), $this); ?>
...
<script>
var del_rep = <?php echo json_encode($this->_tpl_vars['DELETABLE_REPORTS']); ?>
;//#3879 - array of reports that the current user is able to move between folders
...
jQuery(function() {
	...
	var treeData = '; ?>
<?php echo $this->_tpl_vars['REPORTTREE']; ?>
<?php echo ';
	...
	var jsTree = jQuery(\'#\'+treeNodeId).jstree({
		...
		grid: {
			columns: [
				...
				{width: 20, header: translated_labels.label_tools'; ?>
<?php if ($this->_tpl_vars['isAdmin'] == 1): ?>+'&nbsp; <a href="index.php?module=AnalyticReporting&action=index#toggleVisible" onclick="toggleVisible(<?php echo $this->_tpl_vars['TOGGLEHIDDEN']; ?>
);" style="color:blue"><?php if ($this->_tpl_vars['TOGGLEHIDDEN'] == 'true'): ?>'+translated_labels.label_show_hidden+'<?php else: ?>'+translated_labels.label_hide_hidden+'<?php endif; ?></a>'<?php endif; ?><?php echo ', value: "tools"}
			],
		},
		checkbox: {
			tie_selection: false,
	...
	jQuery("[data-action=\'massSchedule\']").click(function(e) {
		...
		if(reportIds.length > 0) {
			...
			var modal = new RactiveDialog({
				...
				partials: {
					modalContent: \'<div class="ar-container"><div id="ar-rv-editor-access"><strong>'; ?>
<?php echo $this->_tpl_vars['MOD']['label_sharing']; ?>
</strong><br><div id="ar-rv-editor-access-sharing"></div><br><strong><?php echo $this->_tpl_vars['MOD']['label_scheduling']; ?>
<?php echo '</strong><br><div id="ar-rv-editor-access-scheduling"></div></div></div>\'
				}
			});
		}else{
    ...
    function checkFonts() {
        ...
        function downloadFonts(modal) {
            ...
            jQuery("#downloadFontsStatus").html("'; ?>
...
<div id="ar-container">
	<div id="ar-toolbar">
		<a href="javascript:void(0);" data-action="addCategory" data-id="0"><?php echo $this->_tpl_vars['MOD']['label_add_folder']; ?>
</a>
		<a href="javascript:void(0);" data-action="massSchedule"><?php echo $this->_tpl_vars['MOD']['label_mass_schedule']; ?>
</a>
		<a href="javascript:void(0);" onclick="pop_include_details();" class="tooltipX"><?php echo $this->_tpl_vars['MOD']['label_to_create_report']; ?>
<span><?php echo $this->_tpl_vars['MOD']['label_to_create_new']; ?>
</span></a>
						<?php if ($this->_tpl_vars['isAdmin'] == 1): ?> 			<a style="float:right" href="index.php?module=AnalyticReporting&action=settings" >Reporting Tool Settings<?php echo $this->_tpl_vars['MOD']['label_settings']; ?>
</a>
		<?php endif; ?>
	</div>
