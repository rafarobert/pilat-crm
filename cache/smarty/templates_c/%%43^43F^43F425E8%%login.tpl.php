<?php /* Smarty version 2.6.31, created on 2021-02-20 13:14:49
         compiled from themes/sp_theme/tpls/login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'themes/sp_theme/tpls/login.tpl', 46, false),)), $this); ?>
<!--
/*********************************************************************************
...
' />
        ...
        <div class="pwstrength_viewport_progress"></div>
          ...
          <button class="btn btn-lg btn-primary btn-block" id="bigbutton" onclick="copypassword();" type="submit" title="<?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_LOGIN_BUTTON_TITLE'), $this);?>
" tabindex="3" name="Login" style="background-color: #CA3213;"><?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_LOGIN_BUTTON_LABEL'), $this);?>
</button>
...
;" onclick='toggleDisplay("forgot_password_dialog");'>
            <a class="btn btn-default btn-block" href='javascript:void(0)'><?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_LOGIN_FORGOT_PASSWORD'), $this);?>
</a>
        </div>
...
">
        ...
        <div class="form-links">
             <?php echo $this->_tpl_vars['LOGIN_WELCOME']; ?>
