 ...
 * Date: Fri Feb 19 2021 18:38:28 GMT-0400 (Bolivia Time)
 * Time: 18:38:28
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Fri Feb 19 2021 18:38:28 GMT-0400 (Bolivia Time)
 * Last time updated: 18:38:28
 *
...
Ext.define('es.view.prospects.List', {
				...
				items: [
					{
						...
						handler: () => {
							...
							var date = new Date();
							//<es-section>
							var count = Ext.getStore('prospects').data.length;
							var nextId = 0;
							for (var i = 0 ; i < count ; i++) {
								var id = Ext.getStore('prospects').getAt(i).data.id;
								if(parseInt(id) > parseInt(nextId.toString())) {
									nextId = parseInt(id);
								}
							}
							Ext.getStore('prospects').insert(count, {
								dueAt: date,
								createdAt: date,
								updatedAt: date,
							});
							Ext.getStore('prospects').getAt(count).set('id',nextId+1);
							//</es-section>
						}
					}, '-' ,
					// {
