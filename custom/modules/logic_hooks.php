...
$hook_array['after_save'][] = Array(60, 'Sugar-Project redirect from dialog', 'custom/modules/SpTheme_return_dialogcls.php','SpTheme_return_dialogcls', 'return_dialog'); 
...
$hook_array['after_ui_frame'][] = Array(67, 'SugarShape Calculator', 'custom/modules/ListViewCalculator.php','ListViewCalculatorCls', 'ListViewCalculator'); 
