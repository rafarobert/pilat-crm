...
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}"  border="0" id="{{$idname}}_trigger"{/capture}
...
document.getElementById('{{$idname}}_time_section').innerHTML = '<span style="top:-6px;"'+text+'</span>';
