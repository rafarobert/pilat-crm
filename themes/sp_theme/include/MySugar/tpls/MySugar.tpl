    ...
    <ul class="nav nav-tabs nav-dashboard">
        ...
        {if !$lock_homepage}
            <li id="tab-actions" class="dropdown">
                ...
                {include file='themes/sp_theme/include/MySugar/tpls/actions_menu.tpl'}
            </li>
        {/if}
    </ul>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="button btn-success btn-add-dashboard" data-dismiss="modal">{$lblAddTab}</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
