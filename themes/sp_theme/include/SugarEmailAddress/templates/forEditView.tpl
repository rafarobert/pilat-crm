...
<div class="col-xs-12" style="padding-left:0px;padding-right:0px;">
	<div class="col-xs-12 email-address-add-line-container emailaddresses" id="{$module}emailAddressesTable{$index}" style="padding-left:0px;padding-right:0px;">
	...
	<div class="col-xs-12 email-address-lines-container" style="padding-left:0px;padding-right:0px;padding-top:10px;">
		...
		<div class="col-xs-12 template email-address-line-container hidden" style="padding-left:0px;padding-right:0px;">
			<div class="col-xs-12 col-sm-6  email-address-input-container {if $module == "Users"} email-address-users-profile{/if}" style="padding-left:0px;padding-right:0px;">
			...
			<div class="col-xs-12 col-sm-6 email-address-options-container" style="padding-left:0px;padding-right:0px;">
				...
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center email-address-option" style="padding-left:0px;padding-right:0px;">
					<label class="text-sm col-xs-12"  style="padding-left:0px;padding-right:0px;">{$app_strings.LBL_EMAIL_PRIMARY}</label>
				...
				{if $useReplyTo == true}
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center email-address-option" style="padding-left:0px;padding-right:0px;">
					<label class="text-sm  col-xs-12"  style="padding-left:0px;padding-right:0px;">{$app_strings.LBL_EMAIL_REPLY_TO}</label>
				...
				{if $useOptOut == true}
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center email-address-option" style="padding-left:0px;padding-right:0px;">
					<label class="text-sm col-xs-12"  style="padding-left:0px;padding-right:0px;">{$app_strings.LBL_EMAIL_OPT_OUT}</label>
				...
				{if $useInvalid == true}
				<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-center email-address-option" style="padding-left:0px;padding-right:0px;">
					<label class="text-sm col-xs-12"  style="padding-left:0px;padding-right:0px;">{$app_strings.LBL_EMAIL_INVALID}</label>
