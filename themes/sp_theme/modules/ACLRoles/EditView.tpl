...
<TR>
<td scope="row" align='right'><label>{$MOD.LBL_NAME}:</label><span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></td><td >
<input id='name' name='name' type='text' value='{$ROLE.name}'>
</td><td>&nbsp;</td><td>&nbsp;</td>
</tr>
<tr>
<td scope="row" align='right'><label>{$MOD.LBL_DESCRIPTION}:</label></td>
