...
<div class="hpanel">  
    ...
    <ul class="nav nav-tabs">
            ...
            <li {if $IS_GROUP_OR_PORTAL}style="display: none;"{/if}><a id="tab2" data-toggle="tab" href="#tab-2"><em>{$MOD.LBL_ADVANCED}</em></a></li>
            {if $SHOW_ROLES}
            <li><a id="tab3" data-toggle="tab" href="#tab-3"><em>{$MOD.LBL_USER_ACCESS}</em></a></li>
            {/if}
    </ul>
