						...
						<table id="sysGeneratedId" name="sysGeneratedName" width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
							<tr>
                              ...
                              <table border=0><tr><td>
															<input type='text' maxlength="3" and style="width:4em"  name='passwordsetting_systexpirationtime' value='{$config.passwordsetting.systexpirationtime}'>
															</td><td><SELECT  NAME="passwordsetting_systexpirationtype">
                             ...
                             <table border=0><tr><td>
															...
															</td><td>{$MOD.LBL_PASSWORD_EXP_AFTER}
															</td><td><input type='text' maxlength="3" and style="width:4em"  name='passwordsetting_systexpirationlogin' value="{$config.passwordsetting.systexpirationlogin}">
															</td><td>{$MOD.LBL_PASSWORD_LOGINS}
                              </td></tr></table>
														</td>
													</tr>
												</table>
											...
											<td colspan="3">
												<table width="100%" border="0" cellspacing="0" cellpadding="0" id="forgot_password_table">
													<tr>
														...
														{/if}
                            <table border=0><tr><td>
															<input type='text' maxlength="3" and style="width:4em" name='passwordsetting_linkexpirationtime'  value='{$config.passwordsetting.linkexpirationtime}'>
															</td><td><SELECT   NAME="passwordsetting_linkexpirationtype">
