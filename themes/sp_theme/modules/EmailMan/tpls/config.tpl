	...
	<div class="panel-content">
		<div class="panel panel-default">
			<div class="panel-heading ">
					<span style="font-weight:700;">{$MOD.LBL_EMAIL_OUTBOUND_CONFIGURATION}
          </span>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading ">
      	<span style="font-weight:700;">{$MOD.LBL_NOTIFY_TITLE}
          </span>
		...
		<div class="panel panel-default">
			<div class="panel-heading ">
         	<span style="font-weight:700;">{$MOD.LBL_SECURITY_TITLE}
          </span>
