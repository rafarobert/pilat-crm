...
<div class="content">
<div id="subpanel_hpanel" class="hpanel">
<ul class="nav nav-tabs">
<li class="active"><a href="#home"  data-toggle="tab" aria-expanded="false">{$mod.LBL_OVERVIEW}</a></li>
<li class=""><a href="#tasks"  data-toggle="tab" aria-expanded="false">{$mod.LBL_TASKS}</a></li>
<li class=""><a href="#meetings"  data-toggle="tab" aria-expanded="false">{$mod.LBL_MEETINGS}</a></li>
<li class=""><a href="#calls"  data-toggle="tab" aria-expanded="false">{$mod.LBL_CALLS}</a></li>
<li class=""><a href="#emails"  data-toggle="tab" aria-expanded="false">{$mod.LBL_EMAILS}</a></li>
<li class=""><a href="#notes"  data-toggle="tab" aria-expanded="false">{$mod.LBL_NOTES}</a></li>
</ul>

    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="home">
            <table class="list view table table-hover table-bordered table-striped">
                <thead>
