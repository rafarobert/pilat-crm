...
<script type="text/javascript" src='{sugar_getjspath file='include/javascript/yui/ygDDList.js'}'></script>
...
<script type="text/javascript" src='{sugar_getjspath file='modules/InboundEmail/InboundEmail.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/EmailUIShared.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/EmailUI.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/EmailUICompose.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/ajax.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/grid.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/init.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/complexLayout.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/composeEmailTemplate.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/displayOneEmailTemplate.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='modules/Emails/javascript/viewPrintable.js'}'></script>
<script type="text/javascript" src='{sugar_getjspath file='include/javascript/quicksearch.js'}'></script>
            
    <link rel="stylesheet" type="text/css" href="themes/SuiteR/css/yui.css">           
        ...
        <tr>
            <td NOWRAP style="padding-bottom: 2px;">
                <button class="button" id="checkEmailButton" onclick="SUGAR.email2.folders.startEmailAccountCheck();">
                    {$app_strings.LBL_EMAIL_CHECK}</button>
                <button class="button" id="composeButton" onclick="SUGAR.email2.composeLayout.c0_composeNewEmail();">
                    {$mod_strings.LNK_NEW_SEND_EMAIL}</button>
                <button class="button" id="settingsButton" onclick="SUGAR.email2.settings.showSettings();">
                    {$app_strings.LBL_EMAIL_SETTINGS}</button>
            </td>
