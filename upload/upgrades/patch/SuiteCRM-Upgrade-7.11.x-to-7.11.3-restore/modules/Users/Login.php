...
$login_image = '<IMG src="' . $login_image_url . '" alt="SuiteCRM" style="margin: 5px auto;">';
...
if (isset($_REQUEST['loginErrorMessage'])) {
    if (isset($mod_strings[$_REQUEST['loginErrorMessage']])) {
        ...
        if (isset($app_strings[$_REQUEST['loginErrorMessage']])) {
           ...
           echo "<p align='center' class='errorhome' > ". $app_strings[$_REQUEST['loginErrorMessage']]. "</p>";
...
$sugar_smarty->assign('LOGIN_WELCOME',  html_entity_decode($sugar_config['sp_theme_login_welcome']));      
