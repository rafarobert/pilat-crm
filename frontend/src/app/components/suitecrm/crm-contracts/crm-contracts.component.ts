...
@Component({
  selector: 'app-crm-contracts',
  templateUrl: './crm-contracts.component.html',
  styleUrls: ['./crm-contracts.component.scss']
})
export class CrmContractsComponent implements OnInit {
  suiteCrmHtml:any;
  urlHome;
  ...
  ngOnInit(): void {
    ...
    this.urlHome = this.sanitizer.bypassSecurityTrustResourceUrl(this.pilatService.httpHome+ '?module=Campaigns&action=index&parentTab=Todo');
  }
