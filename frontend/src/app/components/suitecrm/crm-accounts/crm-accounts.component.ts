...
@Component({
  ...
  templateUrl: './crm-accounts.component.html',
  styleUrls: ['./crm-accounts.component.scss']
})
export class CrmAccountsComponent implements OnInit {
  suiteCrmHtml:any;
  urlHome;
  ...
  ngOnInit(): void {
    ...
    this.urlHome = this.sanitizer.bypassSecurityTrustResourceUrl(this.pilatService.httpHome+ '?module=Accounts&action=index&parentTab=Actividades');
  }
