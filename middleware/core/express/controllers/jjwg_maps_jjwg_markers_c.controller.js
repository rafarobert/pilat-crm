...
jjwgMapsJjwgMarkersCCtrl.getAllJjwgMapsJjwgMarkersC = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.jjwgMapsJjwgMarkersC.rawAttributes,req.body);
        ...
        if (objJjwgMapsJjwgMarkersC && objJjwgMapsJjwgMarkersC.rows && objJjwgMapsJjwgMarkersC.count) {
            util.setSuccess(200, 'JjwgMapsJjwgMarkersC retrieved', objJjwgMapsJjwgMarkersC.rows, objJjwgMapsJjwgMarkersC.count, req.query.limit, req.query.offset);
        } else {
