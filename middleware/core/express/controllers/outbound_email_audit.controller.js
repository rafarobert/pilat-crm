...
outboundEmailAuditCtrl.getAllOutboundEmailAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.outboundEmailAudit.rawAttributes,req.body);
        ...
        if (objOutboundEmailAudit && objOutboundEmailAudit.rows && objOutboundEmailAudit.count) {
            util.setSuccess(200, 'OutboundEmailAudit retrieved', objOutboundEmailAudit.rows, objOutboundEmailAudit.count, req.query.limit, req.query.offset);
        } else {
