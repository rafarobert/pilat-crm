...
amTasktemplatesAuditCtrl.getAllAmTasktemplatesAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.amTasktemplatesAudit.rawAttributes,req.body);
        ...
        if (objAmTasktemplatesAudit && objAmTasktemplatesAudit.rows && objAmTasktemplatesAudit.count) {
            util.setSuccess(200, 'AmTasktemplatesAudit retrieved', objAmTasktemplatesAudit.rows, objAmTasktemplatesAudit.count, req.query.limit, req.query.offset);
        } else {
