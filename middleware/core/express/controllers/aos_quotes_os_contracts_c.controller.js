...
aosQuotesOsContractsCCtrl.getAllAosQuotesOsContractsC = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.aosQuotesOsContractsC.rawAttributes,req.body);
        ...
        if (objAosQuotesOsContractsC && objAosQuotesOsContractsC.rows && objAosQuotesOsContractsC.count) {
            util.setSuccess(200, 'AosQuotesOsContractsC retrieved', objAosQuotesOsContractsC.rows, objAosQuotesOsContractsC.count, req.query.limit, req.query.offset);
        } else {
