...
inboundEmailAutoreplyCtrl.getAllInboundEmailAutoreply = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.inboundEmailAutoreply.rawAttributes,req.body);
        ...
        if (objInboundEmailAutoreply && objInboundEmailAutoreply.rows && objInboundEmailAutoreply.count) {
            util.setSuccess(200, 'InboundEmailAutoreply retrieved', objInboundEmailAutoreply.rows, objInboundEmailAutoreply.count, req.query.limit, req.query.offset);
        } else {
