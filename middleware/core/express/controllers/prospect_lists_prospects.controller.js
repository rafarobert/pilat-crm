...
prospectListsProspectsCtrl.getAllProspectListsProspects = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.prospectListsProspects.rawAttributes,req.body);
        ...
        if (objProspectListsProspects && objProspectListsProspects.rows && objProspectListsProspects.count) {
            util.setSuccess(200, 'ProspectListsProspects retrieved', objProspectListsProspects.rows, objProspectListsProspects.count, req.query.limit, req.query.offset);
        } else {
