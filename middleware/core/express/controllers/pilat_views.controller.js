 ...
 * Date: Fri Feb 26 2021 00:23:30 GMT-0400 (Bolivia Time)
 * Time: 0:23:30
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Fri Feb 26 2021 00:23:30 GMT-0400 (Bolivia Time)
 * Last time updated: 0:23:30
 *
...
pilatViewsCtrl.getAllPilatViews = async (req, res) => {
    try {
        ...
        if (objPilatViews.length > 0) {
            util.setSuccess(200, 'PilatViews retrieved', objPilatViews);
        } else {
