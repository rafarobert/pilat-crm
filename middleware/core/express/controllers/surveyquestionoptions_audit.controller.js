...
surveyquestionoptionsAuditCtrl.getAllSurveyquestionoptionsAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.surveyquestionoptionsAudit.rawAttributes,req.body);
        ...
        if (objSurveyquestionoptionsAudit && objSurveyquestionoptionsAudit.rows && objSurveyquestionoptionsAudit.count) {
            util.setSuccess(200, 'SurveyquestionoptionsAudit retrieved', objSurveyquestionoptionsAudit.rows, objSurveyquestionoptionsAudit.count, req.query.limit, req.query.offset);
        } else {
