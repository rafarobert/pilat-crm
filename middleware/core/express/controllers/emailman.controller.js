 ...
 * Date: Wed Mar 10 2021 14:56:44 GMT-0400 (Bolivia Time)
 * Time: 14:56:44
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:56:44 GMT-0400 (Bolivia Time)
 * Last time updated: 14:56:44
 *
...
emailmanCtrl.getAllEmailman = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.emailman.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objEmailman = await emailmanService.getAllEmailman(req.query);
        if (objEmailman && objEmailman.rows && objEmailman.count) {
            util.setSuccess(200, 'Emailman retrieved', objEmailman.rows, objEmailman.count, req.query.limit, req.query.offset);
        } else {
