 ...
 * Date: Wed Mar 10 2021 14:57:50 GMT-0400 (Bolivia Time)
 * Time: 14:57:50
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:57:50 GMT-0400 (Bolivia Time)
 * Last time updated: 14:57:50
 *
...
surveysAuditCtrl.getAllSurveysAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.surveysAudit.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objSurveysAudit = await surveyAuditService.getAllSurveysAudit(req.query);
        if (objSurveysAudit && objSurveysAudit.rows && objSurveysAudit.count) {
            util.setSuccess(200, 'SurveysAudit retrieved', objSurveysAudit.rows, objSurveysAudit.count, req.query.limit, req.query.offset);
        } else {
