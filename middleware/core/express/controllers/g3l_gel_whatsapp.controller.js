...
g3lGelWhatsappCtrl.getAllG3lGelWhatsapp = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.g3lGelWhatsapp.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objG3lGelWhatsapp = await g3lGelWhatsappService.getAllG3lGelWhatsapp(req.query);
        if (objG3lGelWhatsapp && objG3lGelWhatsapp.rows && objG3lGelWhatsapp.count) {
            util.setSuccess(200, 'G3lGelWhatsapp retrieved', objG3lGelWhatsapp.rows, objG3lGelWhatsapp.count, req.query.limit, req.query.offset);
        } else {
