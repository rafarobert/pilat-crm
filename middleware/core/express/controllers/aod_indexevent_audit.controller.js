 ...
 * Date: Wed Mar 10 2021 14:55:57 GMT-0400 (Bolivia Time)
 * Time: 14:55:57
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:55:57 GMT-0400 (Bolivia Time)
 * Last time updated: 14:55:57
 *
...
aodIndexeventAuditCtrl.getAllAodIndexeventAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.aodIndexeventAudit.rawAttributes,req.body);
        ...
        if (objAodIndexeventAudit && objAodIndexeventAudit.rows && objAodIndexeventAudit.count) {
            util.setSuccess(200, 'AodIndexeventAudit retrieved', objAodIndexeventAudit.rows, objAodIndexeventAudit.count, req.query.limit, req.query.offset);
        } else {
