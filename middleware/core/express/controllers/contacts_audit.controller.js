 ...
 * Date: Wed Mar 10 2021 14:56:37 GMT-0400 (Bolivia Time)
 * Time: 14:56:37
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:56:37 GMT-0400 (Bolivia Time)
 * Last time updated: 14:56:37
 *
...
contactsAuditCtrl.getAllContactsAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.contactsAudit.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objContactsAudit = await contactAuditService.getAllContactsAudit(req.query);
        if (objContactsAudit && objContactsAudit.rows && objContactsAudit.count) {
            util.setSuccess(200, 'ContactsAudit retrieved', objContactsAudit.rows, objContactsAudit.count, req.query.limit, req.query.offset);
        } else {
