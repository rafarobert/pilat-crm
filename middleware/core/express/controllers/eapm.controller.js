 ...
 * Date: Wed Mar 10 2021 14:56:43 GMT-0400 (Bolivia Time)
 * Time: 14:56:43
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:56:43 GMT-0400 (Bolivia Time)
 * Last time updated: 14:56:43
 *
...
eapmCtrl.getAllEapm = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.eapm.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objEapm = await eapmService.getAllEapm(req.query);
        if (objEapm && objEapm.rows && objEapm.count) {
            util.setSuccess(200, 'Eapm retrieved', objEapm.rows, objEapm.count, req.query.limit, req.query.offset);
        } else {
