...
amProjecttemplatesAuditCtrl.getAllAmProjecttemplatesAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.amProjecttemplatesAudit.rawAttributes,req.body);
        ...
        if (objAmProjecttemplatesAudit && objAmProjecttemplatesAudit.rows && objAmProjecttemplatesAudit.count) {
            util.setSuccess(200, 'AmProjecttemplatesAudit retrieved', objAmProjecttemplatesAudit.rows, objAmProjecttemplatesAudit.count, req.query.limit, req.query.offset);
        } else {
