...
fpEventsFpEventDelegates1CCtrl.getAllFpEventsFpEventDelegates1C = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.fpEventsFpEventDelegates1C.rawAttributes,req.body);
        ...
        if (objFpEventsFpEventDelegates1C && objFpEventsFpEventDelegates1C.rows && objFpEventsFpEventDelegates1C.count) {
            util.setSuccess(200, 'FpEventsFpEventDelegates1C retrieved', objFpEventsFpEventDelegates1C.rows, objFpEventsFpEventDelegates1C.count, req.query.limit, req.query.offset);
        } else {
