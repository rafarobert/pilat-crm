...
fpEventLocationsAuditCtrl.getAllFpEventLocationsAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.fpEventLocationsAudit.rawAttributes,req.body);
        ...
        if (objFpEventLocationsAudit && objFpEventLocationsAudit.rows && objFpEventLocationsAudit.count) {
            util.setSuccess(200, 'FpEventLocationsAudit retrieved', objFpEventLocationsAudit.rows, objFpEventLocationsAudit.count, req.query.limit, req.query.offset);
        } else {
