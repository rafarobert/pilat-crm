...
securitygroupsUsersCtrl.getAllSecuritygroupsUsers = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.securitygroupsUsers.rawAttributes,req.body);
        ...
        if (objSecuritygroupsUsers && objSecuritygroupsUsers.rows && objSecuritygroupsUsers.count) {
            util.setSuccess(200, 'SecuritygroupsUsers retrieved', objSecuritygroupsUsers.rows, objSecuritygroupsUsers.count, req.query.limit, req.query.offset);
        } else {
