...
aorScheduledReportsCtrl.getAllAorScheduledReports = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.aorScheduledReports.rawAttributes,req.body);
        ...
        if (objAorScheduledReports && objAorScheduledReports.rows && objAorScheduledReports.count) {
            util.setSuccess(200, 'AorScheduledReports retrieved', objAorScheduledReports.rows, objAorScheduledReports.count, req.query.limit, req.query.offset);
        } else {
