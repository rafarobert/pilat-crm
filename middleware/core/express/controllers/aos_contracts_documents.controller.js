...
aosContractsDocumentsCtrl.getAllAosContractsDocuments = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.aosContractsDocuments.rawAttributes,req.body);
        ...
        if (objAosContractsDocuments && objAosContractsDocuments.rows && objAosContractsDocuments.count) {
            util.setSuccess(200, 'AosContractsDocuments retrieved', objAosContractsDocuments.rows, objAosContractsDocuments.count, req.query.limit, req.query.offset);
        } else {
