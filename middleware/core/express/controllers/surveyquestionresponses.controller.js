...
surveyquestionresponsesCtrl.getAllSurveyquestionresponses = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.surveyquestionresponses.rawAttributes,req.body);
        ...
        if (objSurveyquestionresponses && objSurveyquestionresponses.rows && objSurveyquestionresponses.count) {
            util.setSuccess(200, 'Surveyquestionresponses retrieved', objSurveyquestionresponses.rows, objSurveyquestionresponses.count, req.query.limit, req.query.offset);
        } else {
