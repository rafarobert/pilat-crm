 ...
 * Date: Wed Mar 10 2021 14:57:09 GMT-0400 (Bolivia Time)
 * Time: 14:57:9
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:57:09 GMT-0400 (Bolivia Time)
 * Last time updated: 14:57:9
 *
...
jobQueueCtrl.getAllJobQueue = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.jobQueue.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objJobQueue = await jobQueueService.getAllJobQueue(req.query);
        if (objJobQueue && objJobQueue.rows && objJobQueue.count) {
            util.setSuccess(200, 'JobQueue retrieved', objJobQueue.rows, objJobQueue.count, req.query.limit, req.query.offset);
        } else {
