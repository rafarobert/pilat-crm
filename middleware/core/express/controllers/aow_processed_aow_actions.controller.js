...
aowProcessedAowActionsCtrl.getAllAowProcessedAowActions = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.aowProcessedAowActions.rawAttributes,req.body);
        ...
        if (objAowProcessedAowActions && objAowProcessedAowActions.rows && objAowProcessedAowActions.count) {
            util.setSuccess(200, 'AowProcessedAowActions retrieved', objAowProcessedAowActions.rows, objAowProcessedAowActions.count, req.query.limit, req.query.offset);
        } else {
