 ...
 * Date: Wed Mar 10 2021 14:57:33 GMT-0400 (Bolivia Time)
 * Time: 14:57:33
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:57:33 GMT-0400 (Bolivia Time)
 * Last time updated: 14:57:33
 *
...
projectTaskAuditCtrl.getAllProjectTaskAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.projectTaskAudit.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objProjectTaskAudit = await projectTaskAuditService.getAllProjectTaskAudit(req.query);
        if (objProjectTaskAudit && objProjectTaskAudit.rows && objProjectTaskAudit.count) {
            util.setSuccess(200, 'ProjectTaskAudit retrieved', objProjectTaskAudit.rows, objProjectTaskAudit.count, req.query.limit, req.query.offset);
        } else {
