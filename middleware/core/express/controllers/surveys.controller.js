 ...
 * Date: Wed Mar 10 2021 14:57:49 GMT-0400 (Bolivia Time)
 * Time: 14:57:49
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:57:49 GMT-0400 (Bolivia Time)
 * Last time updated: 14:57:49
 *
...
surveysCtrl.getAllSurveys = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.surveys.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objSurveys = await surveyService.getAllSurveys(req.query);
        if (objSurveys && objSurveys.rows && objSurveys.count) {
            util.setSuccess(200, 'Surveys retrieved', objSurveys.rows, objSurveys.count, req.query.limit, req.query.offset);
        } else {
