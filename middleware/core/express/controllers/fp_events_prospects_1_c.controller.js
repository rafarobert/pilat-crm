...
fpEventsProspects1CCtrl.getAllFpEventsProspects1C = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.fpEventsProspects1C.rawAttributes,req.body);
        ...
        if (objFpEventsProspects1C && objFpEventsProspects1C.rows && objFpEventsProspects1C.count) {
            util.setSuccess(200, 'FpEventsProspects1C retrieved', objFpEventsProspects1C.rows, objFpEventsProspects1C.count, req.query.limit, req.query.offset);
        } else {
