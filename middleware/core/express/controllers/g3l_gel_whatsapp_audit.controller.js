...
g3lGelWhatsappAuditCtrl.getAllG3lGelWhatsappAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.g3lGelWhatsappAudit.rawAttributes,req.body);
        ...
        if (objG3lGelWhatsappAudit && objG3lGelWhatsappAudit.rows && objG3lGelWhatsappAudit.count) {
            util.setSuccess(200, 'G3lGelWhatsappAudit retrieved', objG3lGelWhatsappAudit.rows, objG3lGelWhatsappAudit.count, req.query.limit, req.query.offset);
        } else {
