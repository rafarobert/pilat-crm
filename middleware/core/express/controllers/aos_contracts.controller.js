 ...
 * Date: Wed Mar 10 2021 14:56:07 GMT-0400 (Bolivia Time)
 * Time: 14:56:7
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:56:07 GMT-0400 (Bolivia Time)
 * Last time updated: 14:56:7
 *
...
aosContractsCtrl.getAllAosContracts = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.aosContracts.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objAosContracts = await aoContractService.getAllAosContracts(req.query);
        if (objAosContracts && objAosContracts.rows && objAosContracts.count) {
            util.setSuccess(200, 'AosContracts retrieved', objAosContracts.rows, objAosContracts.count, req.query.limit, req.query.offset);
        } else {
