 ...
 * Date: Wed Mar 10 2021 14:57:53 GMT-0400 (Bolivia Time)
 * Time: 14:57:53
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:57:53 GMT-0400 (Bolivia Time)
 * Last time updated: 14:57:53
 *
...
usersCtrl.getAllUsers = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.users.rawAttributes,req.body);
        ...
        if (objUsers && objUsers.rows && objUsers.count) {
            util.setSuccess(200, 'Users retrieved', objUsers.rows, objUsers.count, req.query.limit, req.query.offset);
        } else {
