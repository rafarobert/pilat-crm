 ...
 * Date: Wed Mar 10 2021 14:56:40 GMT-0400 (Bolivia Time)
 * Time: 14:56:40
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Wed Mar 10 2021 14:56:40 GMT-0400 (Bolivia Time)
 * Last time updated: 14:56:40
 *
...
documentsCtrl.getAllDocuments = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.documents.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objDocuments = await documentService.getAllDocuments(req.query);
        if (objDocuments && objDocuments.rows && objDocuments.count) {
            util.setSuccess(200, 'Documents retrieved', objDocuments.rows, objDocuments.count, req.query.limit, req.query.offset);
        } else {
