...
surveyquestionresponsesAuditCtrl.getAllSurveyquestionresponsesAudit = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.surveyquestionresponsesAudit.rawAttributes,req.body);
        ...
        if (objSurveyquestionresponsesAudit && objSurveyquestionresponsesAudit.rows && objSurveyquestionresponsesAudit.count) {
            util.setSuccess(200, 'SurveyquestionresponsesAudit retrieved', objSurveyquestionresponsesAudit.rows, objSurveyquestionresponsesAudit.count, req.query.limit, req.query.offset);
        } else {
