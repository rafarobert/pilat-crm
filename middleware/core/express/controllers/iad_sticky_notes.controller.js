...
iadStickyNotesCtrl.getAllIadStickyNotes = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.iadStickyNotes.rawAttributes,req.body);
        req.query.limit = length ? length : req.query.limit;
        req.query.offset = start ? start : req.query.offset;
        req.query.order = column && dir ? [[column,dir]] : req.query.order;

        const objIadStickyNotes = await iadStickyNoteService.getAllIadStickyNotes(req.query);
        if (objIadStickyNotes && objIadStickyNotes.rows && objIadStickyNotes.count) {
            util.setSuccess(200, 'IadStickyNotes retrieved', objIadStickyNotes.rows, objIadStickyNotes.count, req.query.limit, req.query.offset);
        } else {
