...
fpEventsFpEventLocations1CCtrl.getAllFpEventsFpEventLocations1C = async (req, res) => {
    try {
        ...
        const [column, dir] = util.getOrderByColumnDirection(models.sequelize.fpEventsFpEventLocations1C.rawAttributes,req.body);
        ...
        if (objFpEventsFpEventLocations1C && objFpEventsFpEventLocations1C.rows && objFpEventsFpEventLocations1C.count) {
            util.setSuccess(200, 'FpEventsFpEventLocations1C retrieved', objFpEventsFpEventLocations1C.rows, objFpEventsFpEventLocations1C.count, req.query.limit, req.query.offset);
        } else {
