...
Ext.define('es.model.esAttributes', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-attributes/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'att_par_type_id', type: 'text', defaultValue: null },
		
		{ name: 'att_code', type: 'text', defaultValue: null },
		
		{ name: 'att_description', type: 'text', defaultValue: null },
		
		{ name: 'att_group', type: 'text', defaultValue: null },
		
		{ name: 'att_par_status_id', type: 'text', defaultValue: null },
