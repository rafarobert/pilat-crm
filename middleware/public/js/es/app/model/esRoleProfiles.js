...
Ext.define('es.model.esRoleProfiles', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-role-profiles/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'rol_pro_group', type: 'text', defaultValue: null },
		
		{ name: 'rol_pro_par_status_id', type: 'text', defaultValue: null },
