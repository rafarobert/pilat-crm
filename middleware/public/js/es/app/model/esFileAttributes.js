...
Ext.define('es.model.esFileAttributes', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-file-attributes/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'fil_id', type: 'text', defaultValue: null },
		
		{ name: 'fil_att_name', type: 'text', defaultValue: null },
		
		{ name: 'fil_att_value', type: 'text', defaultValue: null },
		
		{ name: 'fil_att_group', type: 'text', defaultValue: null },
		
		{ name: 'fil_att_par_status_id', type: 'text', defaultValue: null },
