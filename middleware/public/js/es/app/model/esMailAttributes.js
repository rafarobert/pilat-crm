...
Ext.define('es.model.esMailAttributes', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-mail-attributes/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'mai_id', type: 'text', defaultValue: null },
		
		{ name: 'mai_att_name', type: 'text', defaultValue: null },
		
		{ name: 'mai_att_description', type: 'text', defaultValue: null },
		
		{ name: 'mai_att_group', type: 'text', defaultValue: null },
		
		{ name: 'mai_att_par_status_id', type: 'text', defaultValue: null },
