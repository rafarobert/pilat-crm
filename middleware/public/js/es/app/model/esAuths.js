...
Ext.define('es.model.esAuths', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-auths/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'aut_data', type: 'text', defaultValue: null },
		
		{ name: 'aut_group', type: 'text', defaultValue: null },
		
		{ name: 'aut_par_status_id', type: 'text', defaultValue: null },
