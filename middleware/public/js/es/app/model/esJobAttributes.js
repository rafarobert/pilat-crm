...
Ext.define('es.model.esJobAttributes', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-job-attributes/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'job_id', type: 'text', defaultValue: null },
		
		{ name: 'job_att_name', type: 'text', defaultValue: null },
		
		{ name: 'job_att_description', type: 'text', defaultValue: null },
		
		{ name: 'job_att_group', type: 'text', defaultValue: null },
		
		{ name: 'job_att_par_status_id', type: 'text', defaultValue: null },
