...
Ext.define('es.model.esComponentAttributes', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-component-attributes/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'com_att_name', type: 'text', defaultValue: null },
		
		{ name: 'com_att_description', type: 'text', defaultValue: null },
		
		{ name: 'com_att_group', type: 'text', defaultValue: null },
		
		{ name: 'com_att_par_status_id', type: 'text', defaultValue: null },
