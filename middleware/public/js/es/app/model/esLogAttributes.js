...
Ext.define('es.model.esLogAttributes', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-log-attributes/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'log_id', type: 'text', defaultValue: null },
		
		{ name: 'log_att_name', type: 'text', defaultValue: null },
		
		{ name: 'log_att_description', type: 'text', defaultValue: null },
		
		{ name: 'log_att_group', type: 'text', defaultValue: null },
		
		{ name: 'log_att_par_status_id', type: 'text', defaultValue: null },
