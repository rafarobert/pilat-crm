...
Ext.define('es.model.esProfileViews', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-profile-views/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'vie_id', type: 'text', defaultValue: null },
		
		{ name: 'pro_vie_group', type: 'text', defaultValue: null },
		
		{ name: 'pro_vie_par_status_id', type: 'text', defaultValue: null },
