...
Ext.define('es.model.esObjects', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-objects/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'obj_description', type: 'text', defaultValue: null },
		
		{ name: 'obj_group', type: 'text', defaultValue: null },
		
		{ name: 'obj_par_status_id', type: 'text', defaultValue: null },
