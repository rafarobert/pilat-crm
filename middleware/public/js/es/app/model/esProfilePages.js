...
Ext.define('es.model.esProfilePages', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-profile-pages/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'pro_pag_group', type: 'text', defaultValue: null },
		
		{ name: 'pro_pag_par_status_id', type: 'text', defaultValue: null },
