...
Ext.define('es.model.esProfileComponents', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-profile-components/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'pro_com_group', type: 'text', defaultValue: null },
		
		{ name: 'pro_com_par_status_id', type: 'text', defaultValue: null },
