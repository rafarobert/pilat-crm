...
Ext.define('es.model.esFlows', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-flows/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'flo_description', type: 'text', defaultValue: null },
		
		{ name: 'flo_group', type: 'text', defaultValue: null },
		
		{ name: 'flo_par_status_id', type: 'text', defaultValue: null },
