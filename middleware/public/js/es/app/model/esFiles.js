...
Ext.define('es.model.esFiles', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-files/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'fil_rute', type: 'text', defaultValue: null },
		
		{ name: 'fil_par_type_id', type: 'text', defaultValue: null },
		
		{ name: 'fil_group', type: 'text', defaultValue: null },
		
		{ name: 'fil_par_status_id', type: 'text', defaultValue: null },
