...
Ext.define('es.model.esLogAttributeInstances', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-log-attribute-instances/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'log_att_id', type: 'text', defaultValue: null },
		
		{ name: 'value', type: 'text', defaultValue: null },
		
		{ name: 'log_att_ins_group', type: 'text', defaultValue: null },
		
		{ name: 'log_att_ins_par_status_id', type: 'text', defaultValue: null },
