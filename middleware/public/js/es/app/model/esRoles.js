...
Ext.define('es.model.esRoles', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-roles/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'rol_code', type: 'text', defaultValue: null },
		
		{ name: 'rol_description', type: 'text', defaultValue: null },
		
		{ name: 'rol_abbr', type: 'text', defaultValue: null },
		
		{ name: 'rol_group', type: 'text', defaultValue: null },
		
		{ name: 'rol_par_status_id', type: 'text', defaultValue: null },
