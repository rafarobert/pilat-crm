...
Ext.define('es.model.esJobs', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-jobs/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'job_description', type: 'text', defaultValue: null },
		
		{ name: 'job_group', type: 'text', defaultValue: null },
		
		{ name: 'job_par_status_id', type: 'text', defaultValue: null },
