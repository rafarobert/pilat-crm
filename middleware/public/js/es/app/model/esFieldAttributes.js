...
Ext.define('es.model.esFieldAttributes', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-field-attributes/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'fie_att_name', type: 'text', defaultValue: null },
		
		{ name: 'fie_att_description', type: 'text', defaultValue: null },
		
		{ name: 'fie_att_group', type: 'text', defaultValue: null },
		
		{ name: 'fie_att_par_status_id', type: 'text', defaultValue: null },
