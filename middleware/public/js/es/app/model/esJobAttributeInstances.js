...
Ext.define('es.model.esJobAttributeInstances', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-job-attribute-instances/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'job_att_id', type: 'text', defaultValue: null },
		
		{ name: 'valor', type: 'text', defaultValue: null },
		
		{ name: 'job_att_ins_group', type: 'text', defaultValue: null },
		
		{ name: 'job_att_ins_par_status_id', type: 'text', defaultValue: null },
