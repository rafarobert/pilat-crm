...
Ext.define('es.model.esMailAttributeInstances', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-mail-attribute-instances/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'mai_att_id', type: 'text', defaultValue: null },
		
		{ name: 'value', type: 'text', defaultValue: null },
		
		{ name: 'mai_att_ins_group', type: 'text', defaultValue: null },
		
		{ name: 'mai_att_ins_par_status_id', type: 'text', defaultValue: null },
