...
Ext.define('es.model.esProfileModules', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-esvender/es-profile-modules/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'pro_id', type: 'text', defaultValue: null },
		
		{ name: 'mod_id', type: 'text', defaultValue: null },
		
		{ name: 'pro_mod_group', type: 'text', defaultValue: null },
		
		{ name: 'pro_mod_par_status_id', type: 'text', defaultValue: null },
