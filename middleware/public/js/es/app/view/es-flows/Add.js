...
Ext.define('es.view.es-flows.Add', {
	extend: 'Ext.window.Window',
	alias: 'widget.esFlowsAdd',
	id: 'es-flows-add',
	height: 300,
	width: 369,
	resizable: true,
			...
			items: [
				{
					...
					items: [
						...
						{
							fieldLabel: 'flo_description',
							name: 'flo_description',
						},
						
						{
							fieldLabel: 'flo_group',
							name: 'flo_group',
						},
						...
						
						{
							xtype: new Ext.form.field.ComboBox({
								name: 'flo_par_status_id',
								id: 'flo_par_status_id',
								fieldLabel: 'flo_par_status_id',
