...
Ext.define('es.view.es-profiles.Add', {
	extend: 'Ext.window.Window',
	alias: 'widget.esProfilesAdd',
	id: 'es-profiles-add',
	height: 300,
	width: 369,
	resizable: true,
					...
					items: [
						...
						
						{
							xtype: new Ext.form.field.ComboBox({
								name: 'pro_par_status_id',
								id: 'pro_par_status_id',
								fieldLabel: 'pro_par_status_id',
