...
Ext.define('es.view.es-fields.Add', {
	extend: 'Ext.window.Window',
	alias: 'widget.esFieldsAdd',
	id: 'es-fields-add',
	height: 300,
	width: 369,
	resizable: true,
			...
			items: [
				{
					...
					items: [
						...
						{
							fieldLabel: 'fie_description',
							name: 'fie_description',
						},
						
						{
							fieldLabel: 'fie_group',
							name: 'fie_group',
						},
						...
						
						{
							xtype: new Ext.form.field.ComboBox({
								name: 'fie_par_status_id',
								id: 'fie_par_status_id',
								fieldLabel: 'fie_par_status_id',
