...
Ext.define('es.view.es-objects.Add', {
	extend: 'Ext.window.Window',
	alias: 'widget.esObjectsAdd',
	id: 'es-objects-add',
	height: 300,
	width: 369,
	resizable: true,
			...
			items: [
				{
					...
					items: [
						...
						{
							fieldLabel: 'obj_description',
							name: 'obj_description',
						},
						
						{
							fieldLabel: 'obj_group',
							name: 'obj_group',
						},
						...
						
						{
							xtype: new Ext.form.field.ComboBox({
								name: 'obj_par_status_id',
								id: 'obj_par_status_id',
								fieldLabel: 'obj_par_status_id',
