...
Ext.define('es.view.es-jobs.Add', {
	extend: 'Ext.window.Window',
	alias: 'widget.esJobsAdd',
	id: 'es-jobs-add',
	height: 300,
	width: 369,
	resizable: true,
					...
					items: [
						...
						
						{
							xtype: new Ext.form.field.ComboBox({
								name: 'job_par_status_id',
								id: 'job_par_status_id',
								fieldLabel: 'job_par_status_id',
