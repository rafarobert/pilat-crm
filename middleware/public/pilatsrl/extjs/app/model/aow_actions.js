...
Ext.define('es.model.aowActions', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-pilatsrl/aow-actions/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'action_order', type: 'types.INT', defaultValue: null },
		...
		{ name: 'parameters', type: 'text', defaultValue: null },
