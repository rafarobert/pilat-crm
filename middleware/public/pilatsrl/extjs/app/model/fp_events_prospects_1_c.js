...
Ext.define('es.model.fpEventsProspects1C', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-pilatsrl/fp-events-prospects-1-c/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'fp_events_prospects_1fp_events_ida', type: 'text', defaultValue: null },
		
		{ name: 'fp_events_prospects_1prospects_idb', type: 'text', defaultValue: null },
