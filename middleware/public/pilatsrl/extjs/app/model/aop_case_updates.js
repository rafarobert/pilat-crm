...
Ext.define('es.model.aopCaseUpdates', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-pilatsrl/aop-case-updates/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'internal', type: 'types.TINYINT', defaultValue: null },
		...
		{ name: 'case_id', type: 'types.CHAR', defaultValue: null },
