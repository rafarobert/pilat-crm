...
Ext.define('es.model.aosInvoices', {
	extend: 'Ext.data.Model',

	proxy: {
		type: 'rest',
		//<es-section>
		url : '/api-pilatsrl/aos-invoices/',
		//</es-section>
		reader: {
			type: 'json',
			root: 'data'
	...
	fields: [
		...
		{ name: 'quote_number', type: 'types.INT', defaultValue: null },
		...
		{ name: 'quote_date', type: 'date', defaultValue: null },
		
		{ name: 'invoice_date', type: 'date', defaultValue: null },
		
		{ name: 'due_date', type: 'date', defaultValue: null },
