 ...
 * Date: Sun Mar 07 2021 15:35:32 GMT-0400 (Bolivia Time)
 * Time: 15:35:32
 * Last User updated: Rafael Gutierrez Gaspar
 * Last date updated: Sun Mar 07 2021 15:35:32 GMT-0400 (Bolivia Time)
 * Last time updated: 15:35:32
 *
...
Ext.define('es.view.aos-quotes.List', {
				...
				items: [
					{
						...
						handler: () => {
							...
							var date = new Date();
							//<es-section>
							var count = Ext.getStore('aosQuotes').data.length;
							var nextId = 0;
							for (var i = 0 ; i < count ; i++) {
								var id = Ext.getStore('aosQuotes').getAt(i).data.id;
								if(parseInt(id) > parseInt(nextId.toString())) {
									nextId = parseInt(id);
								}
							}
							Ext.getStore('aosQuotes').insert(count, {
								dueAt: date,
								createdAt: date,
								updatedAt: date,
							});
							Ext.getStore('aosQuotes').getAt(count).set('id',nextId+1);
							//</es-section>
						}
					}, '-' ,
					// {
